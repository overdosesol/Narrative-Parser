...
<a href="https://x.com/Catalystparser">\u{1D54F} \u041f\u043e\u0434\u043f\u0438\u0441\u0430\u0442\u044c\u0441\u044f</a>`,
  ...
  // ── Alerts ─────────────────────────────────────────────────────────────
  // alertHeader \u043F\u043E\u043B\u0443\u0447\u0430\u0435\u0442 alertScore (composite 0-100) \u2014 \u0442\u043E \u0436\u0435 \u0447\u0438\u0441\u043B\u043E, \u0447\u0442\u043E
  // \u0432 \u0430\u0434\u043C\u0438\u043D\u043A\u0435 DecisionsPage. memePotential \u043F\u043E\u043A\u0430\u0437\u044B\u0432\u0430\u0435\u0442\u0441\u044F \u043E\u0442\u0434\u0435\u043B\u044C\u043D\u043E\u0439 \u0441\u0442\u0440\u043E\u043A\u043E\u0439
  // \u043D\u0438\u0436\u0435 \u0447\u0435\u0440\u0435\u0437 alertMemeEnergy, \u0435\u0441\u043B\u0438 \u0440\u0430\u0441\u0445\u043E\u0436\u0434\u0435\u043D\u0438\u0435 \u22658.
  alertHeader: (score) => `${scoreEmoji(score)} <b>${score}/100</b> \u00B7 \u{0422}\u{0420}\u{0415}\u{041D}\u{0414} \u{0410}\u{041B}\u{0415}\u{0420}\u{0422}`,
  alertMemeEnergy: (val) => `\u{1F3AF} \u{041C}\u{0435}\u{043C}-\u{044D}\u{043D}\u{0435}\u{0440}\u{0433}\u{0438}\u{044F} <b>${val}/100</b>`,
...
// Шкала эмодзи откалибрована под alertScore (composite 0-100), а не
// memePotential. После ребаланса 2026-05-10 (meme weight 0.45→0.60)
// топовый меме-тренд теперь набирает ~75-85, а не 55-65 — пороги
// сдвинуты вниз пропорционально:
//   85+ → 🔥🔥🔥 (топ дня)
//   70+ → 🔥🔥   (отличный)
//   55+ → 🔥     (хороший)
//   иначе → 📊   (порог пройден, но без огня)
